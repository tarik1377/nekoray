...
go build -v -o $DEST -trimpath -ldflags "-w -s -X github.com/tarik1377/libneko/neko_common.Version_neko=$version_standalone" -tags "with_clash_api,with_gvisor,with_quic,with_wireguard,with_utls"
popd
